...
//import com.example.GateStatus.domain.vote.service.VoteResultDetail;
...
//    }
//
//    public BillDetailDTO mapToBillDetailDTO(AssemblyApiResponse<JsonNode> apiResponse, String billNo) {
//        if (apiResponse == null || apiResponse.data() == null) {
...
//            );
//        } catch (Exception e) {
//            throw new ApiMappingException("API 응답 매핑 중 오류 발생: ");
//        }
//    }
//
